...
#define	BOX_SIZE	8
#define	DRAW_CHECK	1	/* don't draw the check mark */
...
/*ARGSUSED*/
static void CheckboxInit(Widget request, Widget new,
...
#if DRAW_CHECK
static void CheckboxRealize(Widget w, Mask *valueMask,
...
/* ARGSUSED */
static void CheckboxPress(Widget w, XEvent *event,
...
static void CheckboxUnpress(Widget w, XEvent *event,
