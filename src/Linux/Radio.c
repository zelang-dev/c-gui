...
static	void RadioToggle(), RadioInit(Widget request, Widget new, ArgList args, Cardinal *num_args);
static	void RadioExpose(Widget w, XEvent *event, Region region), RadioResize(Widget w);
static	void RadioDestroy(Widget w, XtPointer junk, XtPointer garbage), RadioClassInit(void), RadioClassPartInit(WidgetClass class);
static	Boolean	RadioSetValues(Widget current, Widget request, Widget new, ArgList args, Cardinal *num_args);
static	void DrawDiamond(Widget w);
static	XtGeometryResult RadioQueryGeometry(Widget w, XtWidgetGeometry *intended, XtWidgetGeometry *preferred);


	/* Action procs */

void	RadioSet(Widget w, XEvent *event, String *params, Cardinal *num_params),
RadioUnset(Widget w, XEvent *event, String *params, Cardinal *num_params);
static	void RadioNotify(), RadioHighlight(Widget w, XEvent *event, String *params, Cardinal *num_params),
RadioUnhighlight(Widget w, XEvent *event, String *params, Cardinal *num_params);


	/* internal privates */

static	void RadioSize(RadioWidget rw, Dimension *w, Dimension *h);		/* find ideal size for widget */
...
/*ARGSUSED*/
static void RadioInit(Widget request, Widget new,
...
/* ARGSUSED */
static Boolean RadioSetValues(Widget current, Widget request, Widget new,
	ArgList args, Cardinal *num_args) {
...
static void RadioHighlight(Widget w, XEvent *event, String *params, Cardinal *num_params){
	RadioWidget	rw = (RadioWidget)w;
	DrawHighlight(w, rw->command.normal_GC);
}


static void RadioUnhighlight(Widget	w, XEvent *event, String *params, Cardinal *num_params) {
	RadioWidget	rw = (RadioWidget)w;
