...
#ifndef _MwBaseComp_H_
#define _MwBaseComp_H_
...
extern WidgetClass mwBaseCompWidgetClass;

typedef struct _MwBaseCompClassRec	*MwBaseCompWidgetClass;
typedef struct _MwBaseCompRec		*MwBaseCompWidget;
